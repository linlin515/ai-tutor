...
public final class DatabaseModule_ProvideAchievementDaoFactory implements Factory<AchievementDao> {
  ...
  public DatabaseModule_ProvideAchievementDaoFactory(Provider<AiTutorDatabase> databaseProvider) {
  ...
  public static AchievementDao provideAchievementDao(AiTutorDatabase database) {

...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class MlkitTextLibraryAccessors extends SubDependencyFactory {
         ...
         * with versionRef 'mlkit.text.recognition'.
             * This dependency was declared in catalog libs.versions.toml
         * @deprecated Will be removed in Gradle 9.0.
             */
        @Deprecated
    ...
    public static class MlkitVersionAccessors extends VersionFactory  {
        ...
        /**
         * Returns the group of versions at versions.mlkit.text
         */
    ...
    public static class MlkitTextVersionAccessors extends VersionFactory  {
        ...
        public MlkitTextVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: mlkit.text.recognition (16.0.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */

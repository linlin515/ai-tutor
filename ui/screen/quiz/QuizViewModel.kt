...
class QuizViewModel @Inject constructor(
    ...
    fun submitAllAnswers() {
        if (_uiState.value.answers.size < _uiState.value.questions.size) return
    ...
    // For testing with mock data when backend is unavailable
    ...
    // Load mock result after user finishes
    fun loadMockResult() {
        val duration = ((System.currentTimeMillis() - startTime) / 1000).toInt()
